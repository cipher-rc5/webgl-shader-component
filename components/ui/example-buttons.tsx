 ...
 */
export function ExampleButtons({ isDisabled }: ExampleButtonsProps): JSX.Element {
  return (
    <div
      className={cn(
      ...
      )}>
      {
        ...
        <button
          ...
          <Search size={14} />
          {example.replace("What's the latest news?", 'Latest News').replace('Help me with research', 'Research')
